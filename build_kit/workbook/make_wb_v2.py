...
ws['A1'] = 'Συστηματική βιβλιογραφική ανασκόπηση: αρχείο προτύπων (έκδοση 2)'; ws['A1'].font = F(bold=True, size=15, color=INK)
...
import os
OUT = os.path.join(os.path.dirname(os.path.abspath(__file__)), '..', 'out', 'LA_review_templates_v2.xlsx'); wb.save(OUT); print('saved', OUT)
