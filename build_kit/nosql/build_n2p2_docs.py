...
a2 = ('<h2 style="margin-top:0">Μέρος 2, λεπτό προς λεπτό</h2>' + tbl('run', ['Λεπτά', 'Διαφάνεια', 'Τι γίνεται'], [
      ...
      ['6–28', '5', 'Αίθουσες. Χρονόμετρο 20:00 μόλις μπουν όλοι. Μηνύματα: στο 10ο λεπτό «όποιος τελείωσε έως το 10, συνεχίζει στα 11 έως 13»· στο 18ο «δύο λεπτά, ετοιμάστε τα πλήθη για το chat».'],
      ...
      + f'<p class="lead">Στο {N10} γίνεται δεκτό και το {C2_ALL}: η <code>countDocuments</code> με το ίδιο, κενό φίλτρο δεν λαμβάνει υπόψη το <code>limit</code>. '
        f'Τα {WORD[PRESENT_FROM - 1]} πρώτα δεν παρουσιάζονται· αν μια ομάδα γράφει εκεί 0, είναι στη βάση test.</p>'
